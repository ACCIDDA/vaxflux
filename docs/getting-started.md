...
[`vaxflux.data.sample_dataset`](api/data.md#vaxflux.data.sample_dataset). This
...
- $m$: The max uptake prevalence, which is the maximum value of the logistic
  curve.
- $r$: The rate of change of the uptake prevalence, which determines how quickly
  the curve rises.
...
1. Select a curve family that represents the vaccine uptake pattern you want to
   model.
